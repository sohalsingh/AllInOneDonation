...
import com.khansaab.allinonedonation.databinding.ActivityRegisterEmailBinding;
...
public class RegisterEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.toolbarBaackBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void validateData(){
        ...
        if(!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
            ...
            binding.cPasswordTil.requestFocus();
        }
        else {
